...
export const Countries: Country[] = [
    ...
    {name: "Congo (Congo-Brazzaville)", alpha2: "CG", alpha3: "COG", numeric: "178"},
    ...
    {name: "Kosovo", alpha2: "XK", alpha3: "XKX", numeric: "999"},
    ...
    {name: "Virgin Islands (British)", alpha2: "VI", alpha3: "VIR", numeric: "092"},
    {name: "Virgin Islands (U.S.)", alpha2: "VN", alpha3: "VNM", numeric: "850"},
